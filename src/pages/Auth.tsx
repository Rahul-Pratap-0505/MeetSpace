...
const Auth = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <div className="flex-grow flex items-center justify-center p-4 transition-colors bg-background dark:bg-background">
      ...
      {/* Always stick footer to the very bottom */}
      <footer className="w-full flex justify-center items-center gap-1 text-muted-foreground text-xs select-none pb-4">
